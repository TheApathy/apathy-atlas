...
exec env ATLAS_DFLASH_ATTN_KGAMMA=1 ATLAS_DFLASH_QUANT=nvfp4 ATLAS_DFLASH_CTX_WINDOW=2048 \
  ...
  /path/to/atlas-src/target/release/spark serve \
  --model-from-path /path/to/models/AEON-Q36-27B-Full --model-name aeon-27b-dflash \
  ...
  --dflash --draft-model /path/to/dflash-retrain/drafter-v1 --dflash-gamma 16 --mtp-vocab 100000 \
