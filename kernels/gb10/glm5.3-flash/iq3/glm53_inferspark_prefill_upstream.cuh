// Vendored verbatim from upstream kernels/gb10/common/inferspark_prefill.cu as of
// perf/glm-5.3-flash-prefill-20260920 (upstream 0b9712868). GLM-5.3's vision
// flash-attention launcher passes upstream's argument list; this tree's common
// copy added query_start/query_len_total, so including it made every GLM image
// prefill fail with CUDA_ERROR_INVALID_VALUE. Keep this copy GLM-local.
