...
# driver on runF_faithful, layers 0..20, MoE fed. Arm A: core fed from the capture (baseline);
...
$BIN --run runF_faithful --layers 21 --feed attn-core,moe --core fed  --tap-dir $OUT/fed  > $OUT/fed.log 2>&1; rc1=$?
$BIN --run runF_faithful --layers 21 --feed attn-core,moe --core real --tap-dir $OUT/real > $OUT/real.log 2>&1; rc2=$?
