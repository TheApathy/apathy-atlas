...
fn unique_max_is_reported_without_replacing_the_selected_oracle() {
    ...
    assert_eq!(record.raw_bf16_fnv1a64, fnv1a_64(&io.row));
    assert_eq!(
...
/// Reference FNV-1a 64 (the `atlas_tier::hash::fnv1a_64` this test was
/// written against; that crate is not part of this tree).
