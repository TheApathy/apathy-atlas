...
impl Qwen3AttentionLayer {
    ...
    fn new_with_gating(
        ...
        Ok(Self {
            ...
            w8a16_gemv_batchm_exact_v2_k: [
                super::super::try_kernel(gpu, "w8a16_gemv_batch4", "w8a16_gemv_batchm_exact_v2_m4"),
                super::super::try_kernel(gpu, "w8a16_gemv_batch4", "w8a16_gemv_batchm_exact_v2_m5"),
                super::super::try_kernel(gpu, "w8a16_gemv_batch4", "w8a16_gemv_batchm_exact_v2_m6"),
                super::super::try_kernel(gpu, "w8a16_gemv_batch4", "w8a16_gemv_batchm_exact_v2_m8"),
            ],
            ...
            // the verify falls back to the per-row chain.
            w8a16_gemv_batch4_k: super::super::try_kernel(
                gpu,
                "w8a16_gemv_batch4",
                "w8a16_gemv_batch4",
            ),
            w8a16_gemv_batch4_ld_k: super::super::try_kernel(
                gpu,
                "w8a16_gemv_batch4",
                "w8a16_gemv_batch4_ld",
            ),
            w4a16_gemv_batch4_ld_k: super::super::try_kernel(
                gpu,
                "w4a16_gemv",
            ...
            w8a8_gemm_pipelined_k: super::super::try_kernel(
                gpu,
                "w8a8_gemm_pipelined",
                "w8a8_gemm_pipelined",
            ),
            ...
            prefill_attn_compressed_tc_k: super::super::try_kernel(
                gpu,
                "prefill_attn_compressed",
