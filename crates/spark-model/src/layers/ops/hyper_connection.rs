...
#[allow(clippy::too_many_arguments)]
/// Prefill-width tiled split: `hc_pre_mix_tiled` (token-tiled, both
/// operands ~once) + `hc_pre_finish`. mix_scratch: [T, mix_hc+1] f32.
#[allow(clippy::too_many_arguments)]
pub fn hc_pre_tiled(
    gpu: &dyn GpuBackend,
    mix_tiled_kernel: KernelHandle,
    ...
    KernelLaunch::new(gpu, mix_tiled_kernel)
