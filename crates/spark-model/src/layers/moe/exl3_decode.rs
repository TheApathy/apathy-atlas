...
impl Exl3MoeState {
    ...
    fn split_for(&self, n: u32) -> u32 {
        exl3_split_for(n, self.split_override)
    }
...
fn exl3_split_for(n: u32, split_override: u32) -> u32 {
    if split_override > 0 {
...
impl MoeLayer {
    ...
    pub fn set_exl3_experts(
        ...
        let split_gu = exl3_split_for(gate.n, split_override);
        let split_dn = exl3_split_for(down.n, split_override);
