...
pub fn tick_work(section: Section, lib: LibraryPhase) -> TickWork {
    ...
    TickWork {
        ...
        // Upstream sets this in the Benchmarks section, which is not ported.
        // Kept as a field rather than deleted: `events.rs` reads it, and the
        // Library's run history will want exactly this signal.
        load_history: false,
    }
}
