...
pub(super) fn victim_selector(source: &str) -> Option<String> {
    ...
    // Reviewed against73d9ca52: dashboard/log registration and test module only;
    // the swap-out marker through EOF and all ownership guards are unchanged.
    const SOURCE_LEN: usize = 42_550;
    const SOURCE_FNV1A: u64 = 0x60cc808dc130b318;
