...
Reads:
    ...
    /path/to/models/z-lab-Qwen3.6-27B-DFlash/model.safetensors
                                     -- drafter weights
...
DRAFTER_PATH = "/path/to/models/z-lab-Qwen3.6-27B-DFlash/model.safetensors"
TARGET_PATH  = "/path/to/models/AEON-Q36-27B-Full/model.safetensors"
