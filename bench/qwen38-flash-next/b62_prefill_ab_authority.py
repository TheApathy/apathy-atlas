...
"""Self-bundle and root-issued live authorization for the b62 campaign."""
...
RESERVATION = Path("/var/tmp/atlas-b62-prefill-gpu-reservation.json")
BOOT_ID = Path("/proc/sys/kernel/random/boot_id")
SCHEMA = "atlas-b62-prefill-root-gpu-authorization-v2"
LANE = "qwen38-flash-next-b62-m2013-prefill-ab-runtime"
MAX_WINDOW_SECONDS = 3_600
HARNESS_NAMES = (
    "b62_prefill_ab.py",
    "b62_prefill_ab_authority.py",
    "b62_prefill_ab_contract.py",
    "b62_prefill_ab_http.py",
    "b62_prefill_ab_identity.py",
    "b62_prefill_ab_inventory.py",
    "b62_prefill_ab_model.py",
    "b62_prefill_ab_process.py",
    "b62_prefill_ab_validate.py",
    "test_b62_prefill_ab.py",
    "test_b62_prefill_ab_authority.py",
    "test_b62_prefill_ab_hostile.py",
    "test_b62_prefill_ab_inventory.py",
)
HARNESS_BUNDLE_SHA256 = (
    "f328aa1140f8af060b4405389d13d4b4408204938c29eedcd4000ca670073213"
)
...
def _boot_hash() -> str:
    raw, _ = _stable_current(BOOT_ID, 256, None)
    return hashlib.sha256(raw).hexdigest()


def load_reservation(*, now: int | None = None) -> dict[str, Any]:
    for value in (contract.MODEL_MANIFEST_SHA256, contract.MODEL_CONTENT_ROOT_SHA256):
...
def input_recheck(manifest: dict[str, Any], full: bool) -> dict[str, Any]:
