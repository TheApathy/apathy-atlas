...
"""Run the sealed b62 control/attention/SSM M2013 qualification once."""
...
import b62_prefill_ab_inventory as inventory
...
def main() -> int:
    ...
    try:
        ...
        inputs_pre = authority.input_recheck(manifest, True)
    ...
    if qualified:
        document = {
            "schema": "atlas-b62-prefill-ab-qualification-v2",
            "qualified": True,
        ...
        document = {
            "schema": "atlas-b62-prefill-ab-failure-v2",
            "qualified": False,
