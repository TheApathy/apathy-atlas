...
def main():
    ...
    ap.add_argument("--arm", default="champion",
                    help="which published configuration this run is (default: champion)")
    ...
    # decode_bench.py writes "rows"; the laguna sibling writes "results". Accept
