...
Useful for any change that's supposed to improve concurrent decode
throughput (where the single-request bench can't surface the win
because it never hits num_seqs > 1 in decode_multi_seq_inner).
