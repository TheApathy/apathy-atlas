...
Model branches were measured on different historical trees. Use three-dot
diffs against `origin/base`, and do not treat experimental branches as release
channels without their branch-local qualification.
