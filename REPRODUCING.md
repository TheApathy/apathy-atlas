...
GitHub default is the measured `laguna` branch. See
[`BRANCHES.md`](BRANCHES.md) for the complete maintained branch map.
...
| `ds4-flash` | DeepSeek-V4-Flash/REAP | `bench/deepseek-v4/` | Single-GB10 bring-up, prefill, decode, MTP and quality evidence. |
| `feat/tui-benchmarks` | Atlas infrastructure | plugin and TUI | Experimental benchmark UI and run-scoped state work. |
| `feat/qwen38-repro-public` | Qwen3.8-27B | `repro/qwen38-coding/` | Sanitized deterministic coding evidence; source/drafter publication pending. |
