...
~48 tok/s at campaign start to **63.9 tok/s** on the valid shipped
v2/BF16-KV profile. The current corrected-ABI v3 control is 58.011965 tok/s.
The former 72.2518 v3 receipt is invalid and quarantined because its host
launcher passed 13 attention arguments to 11-argument PTX, causing chunk-0
attention to return without writing output. The price is that the fork no
longer commits
